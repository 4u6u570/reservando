...
Listado.prototype.eliminoRepetidos = function(arreglo){
    var arregloFinal = arreglo.filter(function(elem, index, self) {
        return index === self.indexOf(elem);
    });
    return arregloFinal.sort();
};
...
Listado.prototype.obtenerCiudades = function() {
   var ciudades = this.restaurantes.map(function(restaurante){
    ...
    return this.eliminoRepetidos(ciudades)
}
...
Listado.prototype.obtenerRubros = function() {
    ...
    return this.eliminoRepetidos(rubros);
}
...
Listado.prototype.obtenerHorarios = function() {
   ...
   return this.eliminoRepetidos(horarios);
}
